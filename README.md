...
```
pip install https://github.com/WeizheXu/coherencepip/releases/download/v0.1.24/coherencecalculator-0.1.24-py3-none-any.whl --no-cache-dir --no-binary gensim
```
